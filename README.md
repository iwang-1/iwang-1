...
Currently, I'm working on software engineering and infrastructure problems across cloud systems, testing, automation, and ML.

## Featured Work

### Quantum NLP Research

I forked and extended a public, GPL-licensed Quantinuum research codebase for quantum natural language processing experiments at UMD.

My work focused on improving the training and evaluation workflow for QNLP classification models, including optimizer experiments with SPSA and Adam-style tuning, reproducible experiment runs, and changes that supported research on quantum circuit-based NLP models.

**Tech:** Python, Jupyter Notebook, DisCoPy, Qiskit, pytket, SPSA, Adam-style optimization

**Repo:** [qnlp_lorenz_etal_2021_resources](https://github.com/iwang-1/qnlp_lorenz_etal_2021_resources)
